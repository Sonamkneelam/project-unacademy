    ...
    const block3adetails=[
        {
            ...
            discription:"Chat with educators, ask questions, answer live polls, and get your doubts cleared - all while the class is going on"
        },
        {
            id:"b32",
            title:"Practice and revise",
            image:"https://static.uacdn.net/web-cms/syllabus_a9da21d824_b20b285483.svg?q=75&w=384",
            discription:"Learning isn't just limited to classes with our practice section, mock tests and lecture notes shared as PDFs for your revision"
        },
        {
            id:"b33",
            title:"Learn anytime, anywhere",
            image:"https://static.uacdn.net/web-cms/learnanytimeanywhere_cb19d5de30_b92bc0c6a1.svg?q=75&w=384",
            discription:"One subscription gets you access to all our live and recorded classes to watch from the comfort of any of your devices Get the learning"
        }
    ]
    return(
        < BeforeHomePageStyled>
            <div className="header">
                ...
                <div className="heading">
                    <div className="head">India’s largest<br/>learning platform</div>
                    ...
                    <div className="block4">
                        <div className="block41">
                            <div className="block411">Get the learning<br/> app</div>
                            <div className="block412">Download lessons and learn anytime,<br/> anywhere with the Unacademy app</div>
                            <div className="block413">
                                <a href="https://apps.apple.com/in/app/unacademy-learning-app/id1342565069?referrer%3Dutm_source%253DFooter%2526utm_medium%253DWebApp%2526utm_campaign%253DFooter%2526"><img src="https://static.uacdn.net/production/_next/static/images/app_store.png?q=75&w=1920" alt="playstore"/></a>
                                <a href="https://play.google.com/store/apps/details?id=com.unacademyapp&referrer=utm_source%3DFooter%26utm_medium%3DWebApp%26utm_campaign%3DFooter%26"><img src="https://static.uacdn.net/production/_next/static/images/play_store.png?q=75&w=1920" alt="playstore"/></a>
                            </div>
                        </div>
...
>>>>>>> 7f0be3a3358c3349446e5627ab2bf9a84b802a99
}
